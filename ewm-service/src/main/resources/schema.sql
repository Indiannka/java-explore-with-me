...
(
    ...
    CONSTRAINT FK_COMMENT_ON_ITEM FOREIGN KEY (event_id) REFERENCES events (event_id) ON DELETE CASCADE,
    CONSTRAINT FK_COMMENT_ON_COMMENT FOREIGN KEY (parent_id) REFERENCES comments (comment_id) ON DELETE CASCADE
);