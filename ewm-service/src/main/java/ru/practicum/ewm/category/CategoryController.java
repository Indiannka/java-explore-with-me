...
public class CategoryController {
    ...
    public CategoryDto getById(@PathVariable("catId") long categoryId) {
        ...
        return categoryConverter.convertToDto(categoryService.getById(categoryId));
    }
    ...
    public CategoryDto create(@Validated({Create.class}) @RequestBody CategoryDto categoryDto) {
        ...
        return categoryConverter.convertToDto(categoryService.createOrUpdate(categoryDto));
    }
